    ...
    <header className="absolute top-0 z-50 w-full pt-4">
      <div className=" container grid grid-cols-3 items-start text-white text-sm text-center rounded-full">
        ...
        <div className="w-fit ml-auto rounded-full uppercase">
          <Link href="/" className="bg-neutral-900 hover:bg-yellow-500 py-2 pl-6 pr-3 text-yellow-500 hover:text-white rounded-l-full transition">Sign up</Link>
          <Link href="/" className="bg-neutral-900 hover:bg-lime-500 py-2 pr-6 pl-3 text-lime-500 hover:text-white rounded-r-full transition">Sign in</Link>
        </div>
      </div>
    </header>
  );
